...
using NovationController.Lib.Integration.MagicHome.Model;
using NovationController.Lib.Integration.MagicHome.Model.Request;
using NovationController.Lib.Integration.MagicHome.Model.Response;
using RestSharp;
