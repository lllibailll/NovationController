...
namespace Lib.Integration.Discord.SDK
{
    ...
    public partial class Discord : IDisposable
    {
        ...
        private Lib.Integration.Discord.SDK.ImageManager.FFIEvents ImageEvents;

        internal Lib.Integration.Discord.SDK.ImageManager ImageManagerInstance;

        private IntPtr ActivityEventsPtr;

        private Lib.Integration.Discord.SDK.ActivityManager.FFIEvents ActivityEvents;

        internal Lib.Integration.Discord.SDK.ActivityManager ActivityManagerInstance;
        ...
        private Lib.Integration.Discord.SDK.LobbyManager.FFIEvents LobbyEvents;

        internal Lib.Integration.Discord.SDK.LobbyManager LobbyManagerInstance;
        ...
        private Lib.Integration.Discord.SDK.StorageManager.FFIEvents StorageEvents;

        internal Lib.Integration.Discord.SDK.StorageManager StorageManagerInstance;

        private IntPtr StoreEventsPtr;

        private Lib.Integration.Discord.SDK.StoreManager.FFIEvents StoreEvents;

        internal Lib.Integration.Discord.SDK.StoreManager StoreManagerInstance;
        ...
        public Discord(Int64 clientId, UInt64 flags)
        {
            ...
            ImageEvents = new Lib.Integration.Discord.SDK.ImageManager.FFIEvents();
            ...
            ActivityEvents = new Lib.Integration.Discord.SDK.ActivityManager.FFIEvents();
            ...
            LobbyEvents = new Lib.Integration.Discord.SDK.LobbyManager.FFIEvents();
            ...
            StorageEvents = new Lib.Integration.Discord.SDK.StorageManager.FFIEvents();
            ...
            StoreEvents = new Lib.Integration.Discord.SDK.StoreManager.FFIEvents();
        ...
        public Lib.Integration.Discord.SDK.ImageManager GetImageManager()
        {
            if (ImageManagerInstance == null) {
                ImageManagerInstance = new Lib.Integration.Discord.SDK.ImageManager(
        ...
        public Lib.Integration.Discord.SDK.ActivityManager GetActivityManager()
        {
            if (ActivityManagerInstance == null) {
                ActivityManagerInstance = new Lib.Integration.Discord.SDK.ActivityManager(
        ...
        public Lib.Integration.Discord.SDK.LobbyManager GetLobbyManager()
        {
            if (LobbyManagerInstance == null) {
                LobbyManagerInstance = new Lib.Integration.Discord.SDK.LobbyManager(
        ...
        public Lib.Integration.Discord.SDK.StorageManager GetStorageManager()
        {
            if (StorageManagerInstance == null) {
                StorageManagerInstance = new Lib.Integration.Discord.SDK.StorageManager(
        ...
        public Lib.Integration.Discord.SDK.StoreManager GetStoreManager()
        {
            if (StoreManagerInstance == null) {
                StoreManagerInstance = new Lib.Integration.Discord.SDK.StoreManager(
    ...
    public partial class ImageManager
    {
        ...
        {
            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            internal delegate void FetchCallback(IntPtr ptr, Result result, Lib.Integration.Discord.SDK.ImageHandle handleResult);

            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            internal delegate void FetchMethod(IntPtr methodsPtr, Lib.Integration.Discord.SDK.ImageHandle handle, bool refresh, IntPtr callbackData, FetchCallback callback);

            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            internal delegate Result GetDimensionsMethod(IntPtr methodsPtr, Lib.Integration.Discord.SDK.ImageHandle handle, ref ImageDimensions dimensions);

            [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
            internal delegate Result GetDataMethod(IntPtr methodsPtr, Lib.Integration.Discord.SDK.ImageHandle handle, byte[] data, Int32 dataLen);
        ...
        public delegate void FetchHandler(Result result, Lib.Integration.Discord.SDK.ImageHandle handleResult);
        ...
        [MonoPInvokeCallback]
        private static void FetchCallbackImpl(IntPtr ptr, Result result, Lib.Integration.Discord.SDK.ImageHandle handleResult)
        {
            GCHandle h = GCHandle.FromIntPtr(ptr);
        ...
        public void Fetch(Lib.Integration.Discord.SDK.ImageHandle handle, bool refresh, FetchHandler callback)
        {
            GCHandle wrapped = GCHandle.Alloc(callback);
            Methods.Fetch(MethodsPtr, handle, refresh, GCHandle.ToIntPtr(wrapped), FetchCallbackImpl);
        }

        public ImageDimensions GetDimensions(Lib.Integration.Discord.SDK.ImageHandle handle)
        {
        ...
        public void GetData(Lib.Integration.Discord.SDK.ImageHandle handle, byte[] data)
        {
